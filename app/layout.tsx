...
export const metadata: Metadata = { title: "Life · Your personal space", description: "Tasks, study, groceries, and your saved finds in one place.", icons: {icon: "/favicon.svg"} };
